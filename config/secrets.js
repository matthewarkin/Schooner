module.exports = {
  ...
  localAuth: true,
  mail: {
    from: process.env.MANDRILL_LOGIN || 'Jordan Cauley <jordan@cauley.co>',
  },

  mandrill: {
    login: process.env.MANDRILL_LOGIN || 'jdcauley',
    password: process.env.MANDRILL_PASSWORD || '_wRNFj_uFLloxWIJggavGw'
  },
